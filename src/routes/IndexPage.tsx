        ...
        <div className="row justify-content-center align-items-center h-inherit">
          ...
          <div className="col-md-6 pt-4">
            <div className="" style={styles.section}>
              <h1 className='display-3 mb-1 animated fadeIn'>Are artisans</h1>
              <h2 className='display-5 font-italic mb-3 animated flipInX'>
                <Typed
                  ...
                  loop
                /></h2>
              <h5 className='display-5 mb-1 animated fadeIn' style={{ fontFamily: PrimaryTheme.fonts?.ProductSansMedium }}>Don't get mad, get started with Artisana</h5>
              <p className="animated fadeIn" style={{ fontFamily: PrimaryTheme.fonts?.ProductSansLight }}>Artisana is a group consisting of users of artisan services to review and improve the quality of services rendered by artisans in Nigeria and beyond. </p>

              <div className="col-md-12 mt-5">
                <div className="row justify-content-start mb-3">
                  <div className="col-md-12 col-lg-6 mb-3">
                    <button className='btn btn-purple border-radius btn-lg w-100' style={{
          ...
          <div className="col-md-6 hero-image">
            <div className="position-relative" style={styles.section}>
              <div className="col-md-12 text-center position-absolute" style={{ bottom: -10 }}>
                <p className='small text-light'>&copy; {new Date().getFullYear()} Artisana Nigeria</p>
              </div>
            </div>
          </div>
        </div>
