      ...
      <div className="container">
        <div className="row">
          <div className="col-md-12 p-5">
            ...
            <SimpleAccordion title="Can I register myself as an Artisan?" body="Yes, artisans can register themselves." />
